...
namespace EmailWebServiceTests.Tests.Configuration.WebControllers
{
    public class EmailBodyVariablesWebControllerTests
    {
        ...
        EmailBodyVariablesWebController _controller;
        IMapper _mapper;
        ILogger _logger;

        public EmailBodyVariablesWebControllerTests()
        {
            ...
            _controller = new EmailBodyVariablesWebController(_mapper, _logger, _emailRODbController, _emailDbController);
        }
        [Fact]
        public async Task EditBodySchemaVariablesAsync()
        {
            ...
            try
            {
                ...
                var resUpdate = ctr.GetEmailBodySchema("test", _httpContext);


                if (resUpdate.Data.EmailSchemaVariables[0].Name == "Zmieniona" && resUpdate.Data.EmailSchemaVariables[0].Value == "wartoϾ zmieniona")
                    return;
                else
