...
{
    public class EmailBodyWebControllerTests
    {
        EmailRODbController _emailRODbController;
        EmailDbController _emailDbController;
        HttpContext _httpContext;
        EmailBodyWebController _controller;
        IMapper _mapper;
        ILogger _logger;

        public EmailBodyWebControllerTests()
        {
            ...
            _controller = new EmailBodyWebController(_mapper, _logger, _emailRODbController, _emailDbController);
        }

        [Fact]
        public async Task EmailBodyWebControllerTest()
        {
            try
            {
                ...
                await _controller.AddEmailBodySchemaAsync("test", model, _httpContext);
                var resAdd = _controller.GetEmailBodySchema("test", _httpContext);
